...
Blockly.Blocks["motion_glidesecstoxy"] = {
    ...
    init: function () {
        this.jsonInit({
            ...
            extensions: ["colours_motion", "shape_statement"],
            helpUrl:
                "https://ampmod.miraheze.org/wiki/Glide_()_seconds_to_x:_()_y:_()",
        });
    },
};
            ...
            args0: [
                {
                    ...
                    options: [
                        [
                            Blockly.Msg.MOTION_SETROTATIONSTYLE_LEFTRIGHT,
                            "left-right",
                        ],
                        [
                            Blockly.Msg.MOTION_SETROTATIONSTYLE_DONTROTATE,
                            "don't rotate",
                        ],
                        [
                            Blockly.Msg.MOTION_SETROTATIONSTYLE_ALLAROUND,
                            "all around",
                        ],
                    ],
                },
...
Blockly.Blocks["motion_position"] = {
    /**
     * Block to report X and Y in an array.
     * @this Blockly.Block
     */
    init: function () {
        this.jsonInit({
            ...
            args0: [
                {
                    ...
                    options: [
                        [
                            Blockly.Msg.MOTION_ALIGNSCENE_BOTTOMLEFT,
                            "bottom-left",
                        ],
                        [
                            Blockly.Msg.MOTION_ALIGNSCENE_BOTTOMRIGHT,
                            "bottom-right",
                        ],
