...
const messages = defineMessages({
    ...
    looks_costumename: {
        ...
        description:
            "Label for the costume name monitor when shown on the stage",
        id: "gui.opcodeLabels.costumename",
    },
    looks_costumenumber: {
        defaultMessage: "costume number",
        description:
            "Label for the costume number monitor when shown on the stage",
        id: "gui.opcodeLabels.costumenumber",
    },
    looks_backdropname: {
        defaultMessage: "backdrop name",
        description:
            "Label for the backdrop name monitor when shown on the stage",
        id: "gui.opcodeLabels.backdropname",
    },
    looks_backdropnumber: {
        defaultMessage: "backdrop number",
        description:
            "Label for the backdrop number monitor when shown on the stage",
    ...
    sensing_current_year: {
        defaultMessage: "year",
        description:
            "Label for the current year monitor when shown on the stage",
        id: "gui.opcodeLabels.year",
    },
    sensing_current_month: {
        defaultMessage: "month",
        description:
            "Label for the current month monitor when shown on the stage.",
        id: "gui.opcodeLabels.month",
    },
    sensing_current_date: {
        defaultMessage: "date",
        description:
            "Label for the current date monitor when shown on the stage. Shows the current day of the month",
        id: "gui.opcodeLabels.date",
    },
    sensing_current_dayofweek: {
        defaultMessage: "day of week",
        description:
            "Label for the current day of week monitor when shown on the stage",
        id: "gui.opcodeLabels.dayofweek",
    },
    sensing_current_hour: {
        defaultMessage: "hour",
        description:
            "Label for the current hour monitor when shown on the stage",
        id: "gui.opcodeLabels.hour",
    },
    sensing_current_minute: {
        defaultMessage: "minute",
        description:
            "Label for the current minute monitor when shown on the stage",
        id: "gui.opcodeLabels.minute",
    },
    sensing_current_second: {
        defaultMessage: "second",
        description:
            "Label for the current second monitor when shown on the stage",
...
class OpcodeLabels {
    ...
    _refreshOpcodeMap() {
        // Motion
        this._opcodeMap.motion_direction.labelFn = () =>
            this._translator(messages.motion_direction);
        this._opcodeMap.motion_xposition.labelFn = () =>
        ...
        this._opcodeMap.looks_backdropname.labelFn = () =>
        ...
        this._opcodeMap.sound_volume.labelFn = () =>
            this._translator(messages.sound_volume);
        this._opcodeMap.sound_tempo.labelFn = () =>
            this._translator(messages.sound_tempo);

        // Sensing
        this._opcodeMap.sensing_answer.labelFn = () =>
            this._translator(messages.sensing_answer);
        this._opcodeMap.sensing_mousedown.labelFn = () =>
            this._translator(messages.sensing_mousedown);
        this._opcodeMap.sensing_mousex.labelFn = () =>
            this._translator(messages.sensing_mousex);
        this._opcodeMap.sensing_mousey.labelFn = () =>
            this._translator(messages.sensing_mousey);
        this._opcodeMap.sensing_loudness.labelFn = () =>
